...
Public Class Add_Channel
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Event_TextBox.Text = "" Then
            MessageBox.Show("Please make sure Channel Name Is filled out before trying To update")
            Exit Sub
        End If
        ...
        con.Open()
        cmd.Connection = con
        cmd.CommandText = "Insert into [Channels]([Channel]) VALUES (@Channel)"
        cmd.Parameters.AddWithValue("@Channel", Event_TextBox.Text)
        cmd.ExecuteNonQuery()
        con.Close()
