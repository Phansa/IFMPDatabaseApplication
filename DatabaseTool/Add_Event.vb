...
Public Class Add_Event
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Event_TextBox.Text = "" Then
            MessageBox.Show("Please make sure Event Name Is filled out before trying To update")
            Exit Sub
        End If
        ...
        con.Open()
        cmd.Connection = con
        cmd.CommandText = "Insert into [Events]([Events]) VALUES (@Events)"
        cmd.Parameters.AddWithValue("@Events", Event_TextBox.Text)
        cmd.ExecuteNonQuery()
        con.Close()
